...
## Next Steps
- [ ] Code review via `/ecc-code-review` command
...
> Next step: Run `/prp-pr` to create a pull request, or `/ecc-code-review` command to review changes first.
```
...
- Run `/ecc-code-review` command to review changes before committing
