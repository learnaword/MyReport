---
name: ecc-go-review
description: Go code review. Use when reviewing Go code for idioms and best practices.
---
...
Use `/ecc-go-review` command when:
...
- Use `/ecc-go-test` command first to ensure tests pass
- Use `/ecc-go-build` command if build errors occur
- Use `/ecc-go-review` command before committing
- Use `/ecc-code-review` command for non-Go specific concerns
