...
description: Code quality and security review. Use after writing or modifying code, when reviewing changes, or before committing. Checks security, performance, best practices.
---
...
1. **Project rules** — Read `project configuration`, `.claude/docs/`, and any contributing guidelines
