...
Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up Cursor in an existing repo for the first time.

## When to Use

- First time opening a project with Cursor
- Joining a new team or repository
- User asks "help me understand this codebase"
- User asks to generate a project configuration for a project
...
#### Output 2: Starter project configuration

Generate or update a project-specific project configuration based on detected conventions. If `project configuration` already exists, read it first and enhance it — preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing project configuration** — if one already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating a project configuration that's longer than 100 lines — keep it focused
...
**Action**: Run full 4-phase workflow → produce Onboarding Guide + Starter project configuration
**Output**: Onboarding Guide printed directly to the conversation, plus a `project configuration` written to the project root

### Example 2: Generate project configuration for existing project
**User**: "Generate a project configuration for this project"
**Action**: Run Phases 1-3, skip Onboarding Guide, produce only project configuration
**Output**: Project-specific `project configuration` with detected conventions

### Example 3: Enhance existing project configuration
**User**: "Update the project configuration with current project conventions"
**Action**: Read existing project configuration, run Phases 1-3, merge new findings
**Output**: Updated `project configuration` with additions clearly marked
