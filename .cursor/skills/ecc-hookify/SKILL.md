...
Create hook rules to prevent unwanted Cursor behaviors by analyzing conversation patterns or explicit user instructions.
...
- Without arguments: use the `ecc-conversation-analyzer` skill to find:
