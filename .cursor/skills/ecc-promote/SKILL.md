...
```bash
python3 ~/.cursor/skills/ecc-continuous-learning-v2/scripts/instinct-cli.py promote [instinct-id] [--force] [--dry-run]
```
...
4. Write promoted instincts to `~/.cursor/homunculus/instincts/personal/` with `scope: global`
