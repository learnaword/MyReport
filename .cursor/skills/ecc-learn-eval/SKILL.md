...
Extends `/ecc-learn` command with a quality gate, save-location decision, and knowledge-placement awareness before writing any skill file.
...
3. **Determine save location:**
   ...
   - **Global** (`~/.cursor/skills/ecc-learned/`): Generic patterns usable across 2+ projects (bash compatibility, LLM API behavior, debugging techniques, etc.)
...
5. **Quality gate — Checklist + Holistic verdict**
   ...
   - [ ] Grep `~/.cursor/skills/` and relevant project `.claude/skills/` files by keyword to check for content overlap
