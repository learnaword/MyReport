...
- Coordinating work across Cursor, Codex, and other harnesses
...
- Supports: Cursor, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (Cursor): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (Cursor): "Write E2E tests for the checkout flow"
```
...
| **Cursor Task tool** | In-process subagent spawning | Programmatic parallelism within a session |
