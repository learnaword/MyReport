...
This command owns **React build/bundler/runtime hydration** failures. For pure TypeScript type errors with no React involvement, use `/ecc-build-fix` command (generic) instead.
...
- `/ecc-build-fix` command — generic build fixer (non-React)
