...
- User says "set up Cursor", "recommend automations", "what plugins or MCPs should I use?", or "what am I missing?"
...
1. Repo surface
   ...
   - `AGENTS.md`, `project configuration`, install manifests, hook configs
