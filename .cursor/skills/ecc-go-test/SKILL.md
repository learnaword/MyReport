---
name: ecc-go-test
description: Go TDD workflow. Use when writing Go tests or implementing Go features with TDD.
---
...
- `/ecc-go-build` command - Fix build errors
- `/ecc-go-review` command - Review code after implementation
