...
6. **Update project project configuration** with PM2 info (see below)
7. **Display completion summary** with terminal commands

---

## Post-Init: Update project configuration

After generating files, append PM2 section to project's `project configuration` (create if not exists):
...
**Rules for project configuration update:**
