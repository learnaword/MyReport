...
Hookify creates rule files that integrate with Cursor's hook system to prevent unwanted behaviors.

### Event Types

- `bash`: triggers on Shell tool use and matches command patterns
