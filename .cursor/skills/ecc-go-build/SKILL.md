---
name: ecc-go-build
description: Fix Go build errors. Use when Go builds fail or module issues occur.
---
...
- `/ecc-go-test` command - Run tests after build succeeds
- `/ecc-go-review` command - Review code quality
