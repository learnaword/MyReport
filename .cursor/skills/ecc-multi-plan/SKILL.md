...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Analysis | `~/.cursor/.ccg/prompts/codex/analyzer.md` | `~/.cursor/.ccg/prompts/gemini/analyzer.md` |
| Planning | `~/.cursor/.ccg/prompts/codex/architect.md` | `~/.cursor/.ccg/prompts/gemini/architect.md` |
...
1. **Codex Backend Analysis**:
   - ROLE_FILE: `~/.cursor/.ccg/prompts/codex/analyzer.md`
...
1. **Codex Plan Draft** (Backend authority):
   - ROLE_FILE: `~/.cursor/.ccg/prompts/codex/architect.md`
