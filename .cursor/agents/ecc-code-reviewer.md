...
description: Expert code review specialist. Proactively reviews code for quality, security, and maintainability. Use immediately after writing or modifying code, when asked to review changes, or before committing.
---
...
When available, also check project-specific conventions from `project configuration` or project rules:
